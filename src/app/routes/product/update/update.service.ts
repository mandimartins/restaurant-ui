...
export class UpdateService {
  ...
  public Save(body:UpdateViewModel):Observable<UpdateViewModel>{
    return this.httpClientService.post(`${environment.RESTAURANT_API}/product/add`,body)
  }
  
  public Get(id:number): Observable<UpdateViewModel>{
    return this.httpClientService.get(`${environment.RESTAURANT_API}/product/get/${id}`)
  }
}
